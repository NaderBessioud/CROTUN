...
export class BrandSignUpComponent implements OnInit {
  ...
  signup(){
  this.service.register(this.client,"CROTUN_99fa8387-ace8-4e53-920e-32cf57ccbb3aavatar.png").subscribe(data =>{
    if(data != null){
...
this.dispoEmail=true
 ...
 CheckUsername(){
   ...
   this.service.verifyUsername(this.client.userName).subscribe(data =>{
     console.log(data);
